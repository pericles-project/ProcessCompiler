...
public class SPARQLQuery {
	...
	public String encode(String query) throws UnsupportedEncodingException {
		return URLEncoder.encode(query, "UTF-8");
	}
	
	public String createQueryGetEntityByID(String id) throws UnsupportedEncodingException {
		String query = "SELECT ?uri WHERE { ?uri <http://www.pericles-project.eu/models#id> \"" + id + "\" . }";
		return encode(query);
	}

	public String createQueryGetImplementationLocation(String id) throws UnsupportedEncodingException {
